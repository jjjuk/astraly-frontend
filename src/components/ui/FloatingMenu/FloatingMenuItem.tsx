...
const FloatingMenuItem: React.FC<{
  ...
  return (
    <div
      ...
      <div className="content absolute whitespace-nowrap -right-2 top-0 text-12 flex items-center opacity-0 group-hover:opacity-100 bg-primary text-white pl-3 h-6 rounded-lg font-bold transition z-0">
