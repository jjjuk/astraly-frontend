...
export const useTokenContract = () => {
  ...
  const getETHContract = async () => getContract(Contracts[CHAIN].eth, ZKP_TOKEN_ABI)
  ...
  const getETHBalance = async (address: string | undefined) => {
  ...
  return { getZKPContract, getZKPBalance, getXZKPBalance, getLPBalance, getETHBalance }
}
